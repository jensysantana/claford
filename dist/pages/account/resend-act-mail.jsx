...
export default function OutToDate({ token, RECAPTCHA_SITE_KEY, appLang, userDataToken }) {
    ...
    useEffect(() => {
        ...
        async function initApp() {
            ...
            try {
                ...
                const { status, data: { message, name } } = await Api.AUTH.resendEmailActivationFromToken({
                    token: token,
                    reCaptch: tokenCap,
                    lang: appLang.lang
                });
