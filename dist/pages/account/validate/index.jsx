...
export default function Validate({ csrfs, token, toApp, RECAPTCHA_SITE_KEY, appLang, userDataToken }) {
    ...
    useEffect(() => {
        ...
        async function initApp() {
            ...
            try {
                ...
                const supData = await Api.AUTH.activateAcc({
                    token: token,
                    reCaptch: tokenCap,
                    csrf: csrfs,
                    lang: appLang.lang
                ...
                console.log('supData 11111111 ');
                console.log(supData);
                console.log('supData 22222 ');
                const { status, data: { message, name } } = supData;
